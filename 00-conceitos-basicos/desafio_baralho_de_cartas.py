...
# mostrar_baralho -> exibe quantidade de cartas no baralho e
# mostra quais são.
...
# DICA: utilize os símbolos ♥️ ♦️ ♣️ ♠️ para representar os naipes.
...
baralho = gerar_baralho(n_copias=1, coringas=False, embaralhado=False)
